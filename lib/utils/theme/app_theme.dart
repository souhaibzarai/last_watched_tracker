...
class AppTheme {
  ...
  static final ThemeData theme = ThemeData().copyWith(
    ...
    textTheme: TextTheme()
        .copyWith(
          displayLarge: getTextStyle(fSize: 27.sp),
          displayMedium: getTextStyle(fSize: 22.sp),
          displaySmall: getTextStyle(fSize: 15.sp),
          headlineLarge: getTextStyle(fSize: 24.sp),
          headlineMedium: getTextStyle(fSize: 18.sp),
          headlineSmall: getTextStyle(fSize: 15.sp),
          titleLarge: getTextStyle(fSize: 17.sp),
          titleMedium: getTextStyle(fSize: 15.sp),
          titleSmall: getTextStyle(fSize: 13.sp),
          bodyLarge: getTextStyle(fSize: 15.sp),
          bodyMedium: getTextStyle(fSize: 13.5.sp),
          bodySmall: getTextStyle(fSize: 12.sp),
          labelLarge: getTextStyle(fSize: 13.sp),
          labelMedium: getTextStyle(fSize: 11.sp),
          labelSmall: getTextStyle(fSize: 10.sp),
        )
        .apply(
